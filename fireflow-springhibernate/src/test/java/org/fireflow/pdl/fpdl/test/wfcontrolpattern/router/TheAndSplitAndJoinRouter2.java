...
public class TheAndSplitAndJoinRouter2 extends FireWorkflowJunitEnviroment {
	...
	protected static final String processDisplayName = "And分支And汇聚流程2";
	...
	public WorkflowProcess createWorkflowProcess(){
		...
		TransitionImpl transition5 = new TransitionImpl(subflow,"activity2_activity3");
		...
		TransitionImpl transition7 = new TransitionImpl(subflow,"activity3_router2");
		...
		subflow.getTransitions().add(transition7);
	...
	public void assertResult(WorkflowSession session){
		...
		q4ActInst.reset();
		q4ActInst.add(Restrictions.eq(ActivityInstanceProperty.PROCESS_INSTANCE_ID, processInstanceId))
				.add(Restrictions.eq(ActivityInstanceProperty.NODE_ID, processName+"."+WorkflowProcess.MAIN_PROCESS_NAME+".Router2"));
