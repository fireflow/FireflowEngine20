...
public class TheConditionSplitOrJoinRouter extends FireWorkflowJunitEnviroment {
	...
	protected static final String processDisplayName = "条件分支-Or汇聚流程";
	...
	public WorkflowProcess createWorkflowProcess(){
		...
		//创建subflow的property
		PropertyImpl property = new PropertyImpl(subflow,"x");
		...
		property = new PropertyImpl(activity1,"y");
		property.setDataType(new QName(NameSpaces.JAVA.getUri(),"java.lang.String"));
		property.setInitialValueAsString("abc");
		activity1.getProperties().add(property);
	...
	public void assertResult(WorkflowSession session){
		...
		//检验activity1的变量
		String abc = (String)activityInstance.getVariableValue(session, "y");
		...
		q4ActInst.reset();
		q4ActInst.add(Restrictions.eq(ActivityInstanceProperty.PROCESS_INSTANCE_ID, processInstanceId))
				.add(Restrictions.eq(ActivityInstanceProperty.NODE_ID, processName+"."+WorkflowProcess.MAIN_PROCESS_NAME+".Activity2"));
