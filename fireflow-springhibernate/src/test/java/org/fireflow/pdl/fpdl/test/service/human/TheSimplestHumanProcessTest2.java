...
//		serviceBinding.setService(humanService);
	...
	public void assertResult(WorkflowSession session) {
		...
		Assert.assertEquals(new Integer(3), procInst.getVersion());
		...
		Assert.assertEquals(new Integer(3), procInstToken.getVersion());
		...
		Assert.assertEquals(new Integer(3), startNodeToken.getVersion());
		Assert.assertEquals(FpdlConstants.PROCESS_TYPE_FPDL20,
		...
		Assert.assertEquals(new Integer(3), activityInstance.getVersion());
		Assert.assertEquals(FpdlConstants.PROCESS_TYPE_FPDL20,
