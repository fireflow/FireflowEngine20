...
/**
 * 调用同一WorkflowProcess中的subflow
 * @author 非也 nychen2000@163.com
 * Fire Workflow 官方网站：www.firesoa.com 或者 www.fireflow.org
 *
 */
public class CallSubflowTest1 extends FireWorkflowJunitEnviroment{
	protected static final String processName = "TheCallSubflowProcess";
	protected static final String processDisplayName = "调用本流程内部的subflow";
	protected static final String description = "调用本流程内部的subflow";
	...
	public void assertResult(WorkflowSession session) {
		...
		//子流程变量
		varQuery.reset();
		varQuery.add(Restrictions.eq(VariableProperty.PROCESS_ELEMENT_ID, processName+WorkflowProcess.ID_SEPARATOR+"subflow2"))
