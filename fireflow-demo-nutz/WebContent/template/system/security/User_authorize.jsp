...
<div id="permissionsDialog" class="ui-dialog-content ui-widget-content" style="display:none;align:center;overflow:auto">
...
function showPermissions(loginName){
	$("#permissionsDialog").html("");
	
	$.ajax({
		url:'${pageContext.request.contextPath}/module/User/getAllPermissionsOfUser',
		type:'POST',
            ...
            fields: {
                ...
                currentPermission:{
                    ...
                    display:function(data){
                    	return '<a href="JavaScript:showPermissions(\''+data.record.loginName+'\')">查看已有权限</a>';
                ...
                userAuthorize:{
                	...
                	display:function(data){
                		...
                		return '<a href="${pageContext.request.contextPath}/module/User/gotoAuthorizeFunction?loginName='+data.record.loginName+'">用户授权</a>';
                	}
                }                
            }
