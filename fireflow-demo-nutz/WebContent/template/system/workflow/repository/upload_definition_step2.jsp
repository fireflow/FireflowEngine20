...
<%
request.setAttribute("thePageTitle","上传流程定义_步骤2");
%>
	...
	$(function() {
		$("#validDateFrom")
				.datepicker(
						{
							showOn : "button",
							buttonImage : "${pageContext.request.contextPath }/static/images/calendar.gif",
...
<div align="center">
	...
	<br />
	<form
		action="${pageContext.request.contextPath }/module/system/workflow/DefinitionsModule/uploadDefinitionsStep2"
		method="post" >
		<table border="0">
			<tr>
