...
<form id="_MainForm_"  action="${pageContext.request.contextPath}/module/holiday/LeaveRequest/updateJson" method="POST" >
...
$(document).ready(function(){
	...
	$("#submit_workflow_button").click(function(){
		$('#_MainForm_').ajaxSubmit({
	        dataType:"json",
	        url:"${pageContext.request.contextPath}/module/holiday/LeaveRequest/updateJson",
	        error: function(request) {
	            alert("保存失败。");
	        },
	        success: function(data) {
